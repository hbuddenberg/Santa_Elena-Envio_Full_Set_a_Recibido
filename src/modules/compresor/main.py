...
def main():
    ...
    archivos = ['FULL SET OE232400596- MAERSK BULAN - TROPME-1.pdf ', 'FULL SET OE232400596- MAERSK BULAN - TROPME.pdf ', 'FULL SET OE232400597- MAERSK BULAN - TROPME.pdf ', 'PACKING LIST  - OE232400597_MAERSK BULAN_TROPME.xls ', 'PACKING LIST - OE232400598_MAERSK BULAN_TROPME.xls ', 'PACKING LIST - OE232400599_MAERSK BULAN_TROPME.xls']
